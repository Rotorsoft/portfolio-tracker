...
export function PortfolioSettings({ portfolioId, name: initName, description: initDesc, currency: initCurrency, cutoffDate: initCutoff, onClose }: Props) {
  ...
  const handleSave = async () => {
    setSaving(true);
    try {
      await updateMutation.mutateAsync({ id: portfolioId, name, description, currency, cutoffDate });
